...
exports.update = async (request, response) => {
  ...
  try {
    ...
    const updatedUser = await Usuario.findOneAndUpdate(
      ...
      newUserData,
      { new: true }
    ); // Pasa como parámetro el ID de la Tarea al método de Mongoose.
...
exports.delete = async (request, response) => {
  ...
  try {
    ...
    /** Elimina el usuario */
    const deletedUser = await Usuario.findOneAndDelete({ _id: user_id }); // Pasa como parámetro el ID de la Tarea al método de Mongoose.
